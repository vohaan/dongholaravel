  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
        <?php
            ...
            if ($message) {
                echo $message;  // nếu có tồn tại thì in ra tin nhắn thông báo
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này không?')" href="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="">
