...
class BrandProduct extends Controller
{
    ...
    public function save_brand_product(Request $request){
        $this->AuthLogin();
        $data = array(); //chuỗi 
        $data['brand_name'] = $request->brand_product_name; //lấy dữ liệu trong database cột name ra từ name brand...e
    ...
    public function unactive_brand_product($brand_product_id){
        $this->AuthLogin();
        DB::table('tbl_brand')->where('brand_id',$brand_product_id)->update(['brand_status'=>1]);  //WHARE LÀ ĐIỀU KIỆN
    ...
    public function show_brand_home($brand_id){
        ...
        $brand_name = DB::table('tbl_brand')->where('tbl_brand.brand_id',$brand_id)->limit(1)->get(); //lấy tên thương hiệu view ra trang chủ
